...
class IPAMap:
	...
	charDict = {'ബ' :'b','ഭ' :'bʱ','ച' :'t͡ʃ','ഛ' :'t͡ʃʰ','ശ' :'ʃ','ഡ' :'ɖ','ഢ' :'ɖʱ','ഗ' :'g','ഘ' :'ɡʱ','ഹ' :'h','ജ' :'ɟ','ഝ' :'ɟʱ','ക' :'k','ഖ' :'kʰ','ള' :'ɭ','ഴ' :'ɻ','മ':'m','ങ' :'ŋ','ഞ' :'ɲ','പ' :'p','റ' :'r','ര' :'ɾ','ഷ' :'ʂ','സ' :'s','ത' :'t̪','യ' :'j','വ' :'ʋ','ന' :'n̪','ന' :'n','അ' :'a','ാ' :'aː','ആ' :'aː','െ' :'e','എ' :'e','േ' :'eː','ഏ' :'eː','ി' :'i','ഇ' :'i','ീ' :'iː','ഈ' :'iː','ൊ' :'o','ഒ' :'o','ോ' :'oː','ഓ' :'oː','ു' :'u','ഉ' :'u','ൂ' :'uː','ഊ' :'uː','ൃ' :'r̥','ഋ' :'r̥','ൈ' :'ai̯','ഐ' :'ai̯','ൗ' :'au̯','ൌ' :'au̯','ഔ' :'au̯','ല' :'l', '്' :'#', 'ട' :'ʈ', 'ണ' :'ɳ' }	ipalist =[]
	charCount = 0;
